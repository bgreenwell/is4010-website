...
Keep this at the one-line level. Lab 02 supplies three single-line docstrings as the contracts the agents implement against, so students only need to read one here. The NumPy format with Parameters and Returns sections is introduced in Week 05, where they first write their own.
:::
