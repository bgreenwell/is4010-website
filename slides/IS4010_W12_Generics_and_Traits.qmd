...
**Try it yourself:** [Run in Rust Playground](https://play.rust-lang.org/?version=stable&mode=debug&edition=2021&code=fn%20main%28%29%20%7B%0Afn%20largest_i32%28list%3A%20%26%5Bi32%5D%29%20-%3E%20%26i32%20%7B%0A%20%20%20%20let%20mut%20largest%20%3D%20%26list%5B0%5D%3B%0A%20%20%20%20for%20item%20in%20list%20%7B%0A%20%20%20%20%20%20%20%20if%20item%20%3E%20largest%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%20largest%20%3D%20item%3B%0A%20%20%20%20%20%20%20%20%7D%0A%20%20%20%20%7D%0A%20%20%20%20largest%0A%7D%0A%0Afn%20largest_f64%28list%3A%20%26%5Bf64%5D%29%20-%3E%20%26f64%20%7B%0A%20%20%20%20let%20mut%20largest%20%3D%20%26list%5B0%5D%3B%0A%20%20%20%20for%20item%20in%20list%20%7B%0A%20%20%20%20%20%20%20%20if%20item%20%3E%20largest%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%20largest%20%3D%20item%3B%0A%20%20%20%20%20%20%20%20%7D%0A%20%20%20%20%7D%0A%20%20%20%20largest%0A%7D%0A%7D%0A)
...
**Try it yourself:** [Run in Rust Playground](https://play.rust-lang.org/?version=stable&mode=debug&edition=2021&code=fn%20main%28%29%20%7B%0Afn%20largest%3CT%3A%20PartialOrd%3E%28list%3A%20%26%5BT%5D%29%20-%3E%20%26T%20%7B%0A%20%20%20%20let%20mut%20largest%20%3D%20%26list%5B0%5D%3B%0A%20%20%20%20for%20item%20in%20list%20%7B%0A%20%20%20%20%20%20%20%20if%20item%20%3E%20largest%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%20largest%20%3D%20item%3B%0A%20%20%20%20%20%20%20%20%7D%0A%20%20%20%20%7D%0A%20%20%20%20largest%0A%7D%0A%0A%2F%2F%20Works%20with%20any%20type%20that%20can%20be%20compared%21%0Alet%20numbers%20%3D%20vec%21%5B34%2C%2050%2C%2025%2C%20100%2C%2065%5D%3B%0Alet%20result%20%3D%20largest%28%26numbers%29%3B%0A%0Alet%20chars%20%3D%20vec%21%5B%27y%27%2C%20%27m%27%2C%20%27a%27%2C%20%27q%27%5D%3B%0Alet%20result%20%3D%20largest%28%26chars%29%3B%0A%7D%0A)
...
**Try it yourself:** [Run in Rust Playground](https://play.rust-lang.org/?version=stable&mode=debug&edition=2021&code=struct%20Point%3CT%3E%20%7B%0A%20%20%20%20x%3A%20T%2C%0A%20%20%20%20y%3A%20T%2C%0A%7D%0A%0Afn%20main%28%29%20%7B%0A%20%20%20%20let%20integer_point%20%3D%20Point%20%7B%20x%3A%205%2C%20y%3A%2010%20%7D%3B%0A%20%20%20%20let%20float_point%20%3D%20Point%20%7B%20x%3A%201.0%2C%20y%3A%204.0%20%7D%3B%0A%7D%0A)
...
**Try it yourself:** [Run in Rust Playground](https://play.rust-lang.org/?version=stable&mode=debug&edition=2021&code=struct%20Point%3CT%2C%20U%3E%20%7B%0A%20%20%20%20x%3A%20T%2C%0A%20%20%20%20y%3A%20U%2C%0A%7D%0A%0Afn%20main%28%29%20%7B%0A%20%20%20%20let%20mixed%20%3D%20Point%20%7B%20x%3A%205%2C%20y%3A%204.0%20%7D%3B%20%20%2F%2F%20T%3Di32%2C%20U%3Df64%0A%7D%0A)
...
**Try it yourself:** [Run in Rust Playground](https://play.rust-lang.org/?version=stable&mode=debug&edition=2021&code=fn%20main%28%29%20%7B%0A%2F%2F%20Option%3CT%3E%20from%20standard%20library%0Aenum%20Option%3CT%3E%20%7B%0A%20%20%20%20Some%28T%29%2C%0A%20%20%20%20None%2C%0A%7D%0A%0A%2F%2F%20Result%3CT%2C%20E%3E%20for%20error%20handling%0Aenum%20Result%3CT%2C%20E%3E%20%7B%0A%20%20%20%20Ok%28T%29%2C%0A%20%20%20%20Err%28E%29%2C%0A%7D%0A%7D%0A)
...
**Try it yourself:** [Run in Rust Playground](https://play.rust-lang.org/?version=stable&mode=debug&edition=2021&code=fn%20main%28%29%20%7B%0Afn%20validate_username%28name%3A%20%26str%29%20-%3E%20Result%3C%26str%2C%20String%3E%20%7B%0A%20%20%20%20if%20name.trim%28%29.is_empty%28%29%20%7B%0A%20%20%20%20%20%20%20%20Err%28String%3A%3Afrom%28%22Username%20cannot%20be%20empty%22%29%29%0A%20%20%20%20%7D%20else%20%7B%0A%20%20%20%20%20%20%20%20Ok%28name%29%0A%20%20%20%20%7D%0A%7D%0A%7D%0A)
...
**Try it yourself:** [Run in Rust Playground](https://play.rust-lang.org/?version=stable&mode=debug&edition=2021&code=fn%20main%28%29%20%7B%0Astruct%20Point%3CT%3E%20%7B%0A%20%20%20%20x%3A%20T%2C%0A%20%20%20%20y%3A%20T%2C%0A%7D%0A%0Aimpl%3CT%3E%20Point%3CT%3E%20%7B%0A%20%20%20%20fn%20x%28%26self%29%20-%3E%20%26T%20%7B%0A%20%20%20%20%20%20%20%20%26self.x%0A%20%20%20%20%7D%0A%7D%0A%0A%2F%2F%20Method%20only%20for%20specific%20type%0Aimpl%20Point%3Cf32%3E%20%7B%0A%20%20%20%20fn%20distance_from_origin%28%26self%29%20-%3E%20f32%20%7B%0A%20%20%20%20%20%20%20%20%28self.x.powi%282%29%20%2B%20self.y.powi%282%29%29.sqrt%28%29%0A%20%20%20%20%7D%0A%7D%0A%7D%0A)
...
**Try it yourself:** [Run in Rust Playground](https://play.rust-lang.org/?version=stable&mode=debug&edition=2021&code=fn%20main%28%29%20%7B%0Apub%20trait%20Summary%20%7B%0A%20%20%20%20fn%20summarize%28%26self%29%20-%3E%20String%3B%0A%7D%0A%0Astruct%20NewsArticle%20%7B%0A%20%20%20%20headline%3A%20String%2C%0A%20%20%20%20content%3A%20String%2C%0A%7D%0A%0Aimpl%20Summary%20for%20NewsArticle%20%7B%0A%20%20%20%20fn%20summarize%28%26self%29%20-%3E%20String%20%7B%0A%20%20%20%20%20%20%20%20format%21%28%22%7B%7D%3A%20%7B%7D%22%2C%20self.headline%2C%20self.content%29%0A%20%20%20%20%7D%0A%7D%0A%7D%0A)
...
**Try it yourself:** [Run in Rust Playground](https://play.rust-lang.org/?version=stable&mode=debug&edition=2021&code=fn%20main%28%29%20%7B%0Apub%20trait%20Summary%20%7B%0A%20%20%20%20fn%20summarize_author%28%26self%29%20-%3E%20String%3B%0A%0A%20%20%20%20fn%20summarize%28%26self%29%20-%3E%20String%20%7B%0A%20%20%20%20%20%20%20%20format%21%28%22%28Read%20more%20from%20%7B%7D...%29%22%2C%20self.summarize_author%28%29%29%0A%20%20%20%20%7D%0A%7D%0A%0Astruct%20Tweet%20%7B%0A%20%20%20%20username%3A%20String%2C%0A%20%20%20%20content%3A%20String%2C%0A%7D%0A%0Aimpl%20Summary%20for%20Tweet%20%7B%0A%20%20%20%20fn%20summarize_author%28%26self%29%20-%3E%20String%20%7B%0A%20%20%20%20%20%20%20%20format%21%28%22%40%7B%7D%22%2C%20self.username%29%0A%20%20%20%20%7D%0A%20%20%20%20%2F%2F%20summarize%28%29%20uses%20the%20default%20implementation%0A%7D%0A%7D%0A)
...
::: {.notes}
This is where generics and traits come together. There are three syntaxes shown, and they all mean the same thing, just with different readability trade-offs:

1. `&impl Summary`: "any reference to something that implements Summary", which reads naturally, so use it for simple cases
...
Python type checkers like mypy will flag calls to `notify` with non-conforming types. But at runtime, Python doesn't care, and it will call `.summarize()` on whatever you pass and only fail if the method doesn't exist.
...
**Try it yourself:** [Run in Rust Playground](https://play.rust-lang.org/?version=stable&mode=debug&edition=2021&code=%23%5Bderive%28Debug%2C%20Clone%2C%20PartialEq%2C%20Eq%29%5D%0Astruct%20Point%20%7B%0A%20%20%20%20x%3A%20i32%2C%0A%20%20%20%20y%3A%20i32%2C%0A%7D%0A%0Afn%20main%28%29%20%7B%0A%20%20%20%20let%20p1%20%3D%20Point%20%7B%20x%3A%201%2C%20y%3A%202%20%7D%3B%0A%20%20%20%20let%20p2%20%3D%20p1.clone%28%29%3B%0A%0A%20%20%20%20println%21%28%22%7B%3A%3F%7D%22%2C%20p1%29%3B%20%20%2F%2F%20Debug%0A%20%20%20%20assert_eq%21%28p1%2C%20p2%29%3B%20%20%20%20%2F%2F%20PartialEq%0A%7D%0A)
...
**Try it yourself:** [Run in Rust Playground](https://play.rust-lang.org/?version=stable&mode=debug&edition=2021&code=use%20std%3A%3Afmt%3B%0A%0Astruct%20Point%20%7B%0A%20%20%20%20x%3A%20i32%2C%0A%20%20%20%20y%3A%20i32%2C%0A%7D%0A%0Aimpl%20fmt%3A%3ADisplay%20for%20Point%20%7B%0A%20%20%20%20fn%20fmt%28%26self%2C%20f%3A%20%26mut%20fmt%3A%3AFormatter%29%20-%3E%20fmt%3A%3AResult%20%7B%0A%20%20%20%20%20%20%20%20write%21%28f%2C%20%22%28%7B%7D%2C%20%7B%7D%29%22%2C%20self.x%2C%20self.y%29%0A%20%20%20%20%7D%0A%7D%0A%0Afn%20main%28%29%20%7B%0A%20%20%20%20let%20p%20%3D%20Point%20%7B%20x%3A%201%2C%20y%3A%202%20%7D%3B%0A%20%20%20%20println%21%28%22Point%3A%20%7B%7D%22%2C%20p%29%3B%20%20%2F%2F%20Point%3A%20%281%2C%202%29%0A%7D%0A)
...
**Try it yourself:** [Run in Rust Playground](https://play.rust-lang.org/?version=stable&mode=debug&edition=2021&code=fn%20main%28%29%20%7B%0Astruct%20Counter%20%7B%0A%20%20%20%20count%3A%20u32%2C%0A%7D%0A%0Aimpl%20Counter%20%7B%0A%20%20%20%20fn%20new%28%29%20-%3E%20Counter%20%7B%0A%20%20%20%20%20%20%20%20Counter%20%7B%20count%3A%200%20%7D%0A%20%20%20%20%7D%0A%7D%0A%0Aimpl%20Iterator%20for%20Counter%20%7B%0A%20%20%20%20type%20Item%20%3D%20u32%3B%20%20%2F%2F%20Associated%20type%0A%0A%20%20%20%20fn%20next%28%26mut%20self%29%20-%3E%20Option%3CSelf%3A%3AItem%3E%20%7B%0A%20%20%20%20%20%20%20%20if%20self.count%20%3C%205%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%20self.count%20%2B%3D%201%3B%0A%20%20%20%20%20%20%20%20%20%20%20%20Some%28self.count%29%0A%20%20%20%20%20%20%20%20%7D%20else%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%20None%0A%20%20%20%20%20%20%20%20%7D%0A%20%20%20%20%7D%0A%7D%0A%7D%0A)
