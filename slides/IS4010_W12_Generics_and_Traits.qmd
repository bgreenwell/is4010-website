...
**Why it matters**: These patterns make Rust code expressive, safe, and production-ready.
...
- **Iterators:** The `Iterator` implementation for `Stack<T>` provides the bridge to Week 13's iterator pipelines and closures.
...
Lab 13 continues the weekly cadence. Encourage students to finish Lab 12's Iterator implementation before moving on.
:::
...
**Lab due: Sunday, April 12, 2026, at 11:59 PM**
