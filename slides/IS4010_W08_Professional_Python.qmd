...
- `weather_api.py`: `WeatherAPI` calls the specified current and forecast endpoints with `params` and `timeout=10`; formatting functions produce the required text
