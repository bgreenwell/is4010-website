...
- **Advanced AI workflows and final-project support** (week 15)
:::
...
- **`git add <reviewed-file>`** - Stage another file after reviewing it
...
git add <reviewed-file> # Stage a file after reviewing it
