...
Include an `AGENTS.md` file in the root of your repository documenting how you used AI tools during development. This is not a formality, so write honestly about where AI helped, where it steered you wrong, and what you learned from the collaboration.
